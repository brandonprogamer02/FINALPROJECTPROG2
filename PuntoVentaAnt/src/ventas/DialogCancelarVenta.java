...
public class DialogCancelarVenta extends interfaz.DialogWithAnimation {

    
    public DialogCancelarVenta(java.awt.Frame parent, boolean modal) 
    {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel25.setText("Deseas Eliminar ");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try
        {
            ...
            VentanaLogin.ventana.getPanelActual();
            
                System.out.println("EL ID DEL ULTIMO REGISTRO ES:" + idUltimoRegistro);
                Eliminacion.eliminarDetalleVenta(idUltimoRegistro);
